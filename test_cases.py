...
class TestLibrarySystem(unittest.TestCase):
    ...
    def test_search_with_special_characters(self):
        self.library_system.add_book("C++ Primer", "Author C", "ISBN003")
    ...
    def test_add_and_search_books(self):
        self.library_system.add_book("Advanced Python", "Author D", "ISBN004")
        found_books = self.library_system.search_books_by_title("Python")
        # Ensure the new book is in the search results
